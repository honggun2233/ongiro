export default function Footer() {
  return (
    <footer style={{ background: '#1A1008' }}>
      <div className="max-w-6xl mx-auto px-5 py-12 md:px-16 md:py-16">
        <div className="footer-top flex justify-between mb-12">
          <div>
        ...
        <div className="footer-bottom flex justify-between items-center pt-8" style={{ borderTop: '1px solid rgba(245,240,232,0.08)' }}>
