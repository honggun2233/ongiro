...
export default function HeroSection({ onOpenModal }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="hero-content-wrap relative z-10 px-16 max-w-6xl mx-auto w-full">
      ...
      <div className="hero-card-wrap hero-anim-6 absolute right-0 top-1/2 -translate-y-1/2 w-[45%]">
